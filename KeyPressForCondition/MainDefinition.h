...
#define FIELD_SHIFT_TIMER_PAGE(x)				(5 + FIELDS_TIMER_PAGE * x)
...
#define FIELDS_PIXELEVENTS_PAGE 10 
...
#define FIELD_SHIFT_PIXELEVENTS_PAGE(x)			(9 + FIELDS_PIXELEVENTS_PAGE * x)
...
#define ID_SHIFT_PIXELEVENTS_PAGE				(2180)
